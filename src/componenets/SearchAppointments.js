        ...
        return (
            ...
            <div className="col-md-6">
              <div className="input-group">
                <input // input field for the search box
                  id="SearchApts"
                  type="text"
                ...
                <div className="input-group-append">
                  ...
                  <div className="sort-menu dropdown-menu dropdown-menu-right">
                    <button className={
                        ...
                        (this.props.orderBy === 'petName' ? 'active': '') // if oderby is gelijk aan petname dan voeg active als class toe if not, voeg niks toe
                    }
